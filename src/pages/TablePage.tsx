...
export const TablePage = () => {
  ...
  const { isDisplayed } = useAppSelector(state => state.art);
        ...
        status === 200 ? (
          <>
            ...
            <p className='text-center'>
              I have my little passion - Digital art. I'm just a beginner, so if you DON'T WANT to see some of my artworks, please, DON'T TOUCH <Button variant="danger" onClick={() => disatch(show())}>
                THIS BUTTON
              </Button>
            </p>
            {isDisplayed && <AboutMe />}
